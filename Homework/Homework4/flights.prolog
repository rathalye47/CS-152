...
% Case for direct flights.
route(Departing, Arriving, _, DepartureTime, ArrivalTime, Flights, TotalCost) :-
    flight(Departing, Arriving, DepartureTime, ArrivalTime, TotalCost),
    Flights = [Departing, Arriving].

% Case for flights with any transfers through intermediary airports.
route(Departing, Arriving, Visited, DepartureTime, ArrivalTime, Flights, TotalCost) :-
    flight(Departing, Transfer, DepartureTime, TransferArrivalTime, InitCost),
    Transfer \= Arriving,
    not(member(Transfer, Visited)),
    route(Transfer, Arriving, [Departing|Visited], TransferDepartureTime, ArrivalTime, RestAirports, RestCost),
    TransferArrivalTime @< TransferDepartureTime,
    TotalCost is InitCost + RestCost,
    Flights = [Departing|RestAirports].
